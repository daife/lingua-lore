...
const RELEASE_URL: &str = "https://api.github.com/repos/daife/lingua-lore/releases/latest";
const ANNOUNCEMENT_BASE_URL: &str =
    "https://raw.githubusercontent.com/daife/lingua-lore/main/announcements";
...
pub async fn check_announcement() -> AnnouncementResult {
    ...
    let url = format!("{ANNOUNCEMENT_BASE_URL}/{platform}.md");
